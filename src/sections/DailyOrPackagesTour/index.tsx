...
import { useHomeTourForType } from "@/utils/handleTour";
...
export function DailyOrPackagesTourSection({
  isDailyTour,
}: {
  isDailyTour: boolean;
}): JSX.Element {
  ...
  const dataTour = useHomeTourForType(
    isDailyTour ? 1 : 0,
    sort,
    typeSort,
    search
  ...
  return (
    <div className="-mt-[var(--height-header)]">
      ...
      <IntroCruiseAndTour
        title={
          isDailyTour ? "All 43 Best Daily Tours" : "All 43 Best Packages Tours"
        }
        description={
